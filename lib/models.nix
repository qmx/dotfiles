# Model catalog for llama-swap and opencode
{
  ...
  models = {
    ...
    "Qwen3-Coder-30B-Q4-128K-KVQ8" = {
      ...
      opencode = {
        displayName = "Qwen3 Coder 30B Q4 128K KVQ8";
        reasoning = false;
        toolCall = true;
        contextLimit = 131072;
        outputLimit = 65536;
    ...
    "Qwen3-Coder-30B-Q5_K_XL-200K-2x-KVQ8" = {
      ...
      group = "coding";
      opencode = {
        displayName = "Qwen3 Coder 30B Q5_K_XL 200K 2x KVQ8";
        reasoning = false;
        toolCall = true;
        contextLimit = 204800;
        outputLimit = 65536;
    ...
    "Qwen3-Coder-30B-Q4-200K-2x-KVQ8" = {
      ...
      group = "coding";
      opencode = {
        displayName = "Qwen3 Coder 30B Q4 200K 2x KVQ8";
        reasoning = false;
        toolCall = true;
        contextLimit = 204800;
        outputLimit = 65536;
    ...
    "Qwen3-Coder-30B-Q4-200K-2x-KVQ8-rocm" = {
      ...
      group = "coding";
      opencode = {
        displayName = "Qwen3 Coder 30B Q4 200K 2x KVQ8 (ROCm)";
        reasoning = false;
        toolCall = true;
        contextLimit = 204800;
        outputLimit = 65536;
    ...
    "Qwen3-Coder-30B-Q4-200K-2x-KVQ8-vulkan" = {
      ...
      group = "coding";
      opencode = {
        displayName = "Qwen3 Coder 30B Q4 200K 2x KVQ8 (Vulkan)";
        reasoning = false;
        toolCall = true;
        contextLimit = 204800;
        outputLimit = 65536;
